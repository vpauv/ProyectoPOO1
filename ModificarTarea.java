...
public class ModificarTarea extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        TareaN tarea;
        tarea = ventana.usrActual.tareasPendientes.get(ventana.pos);
        ventana.usrActual.tareasPendientes.remove(ventana.pos);
        tarea.cambiarAenProceso();
        ventana.usrActual.tareasEnProceso.add(tarea);
        ventana.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarTarea ModTarea = new ModificarTarea();
