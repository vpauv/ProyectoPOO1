...
public class ModificarTareaTerminada extends javax.swing.JFrame {
    public TareaN tareaSelec;
    public Usuario usrActual;
    public ModificarTareaTerminada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("     \n    ¿Estas seguro que deseas entregar \n                esta tarea?");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        TareaN tarea;
        tarea = ventana.usrActual.tareasTerminadas.get(ventana.pos);
        ventana.usrActual.tareasTerminadas.remove(ventana.pos);
        tarea.cambiarAterminada();
        ventana.usrActual.tareasEntregadas.add(tarea);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTareaTerminada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarTareaTerminada ModTarea = new ModificarTareaTerminada();
